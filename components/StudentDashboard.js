...
const StudentDashboard = () => {
  ...
  const weeklySchedule = {
    Monday: [
      { time: "09:00-10:30", subject: "Data Structures", teacher: "Dr. Smith", room: "Lab-1" },
      { time: "10:45-12:15", subject: "Mathematics", teacher: "Prof. Johnson", room: "Room-205" },
      { time: "14:00-15:30", subject: "Database Systems", teacher: "Dr. Brown", room: "Lab-2" },
    ],
    Tuesday: [
      { time: "09:00-10:30", subject: "Web Development", teacher: "Ms. Wilson", room: "Lab-3" },
      { time: "10:45-12:15", subject: "Computer Networks", teacher: "Dr. Davis", room: "Room-301" },
    ],
    Wednesday: [
      { time: "09:00-10:30", subject: "Machine Learning", teacher: "Prof. Lee", room: "Lab-1" },
      { time: "10:45-12:15", subject: "Software Engineering", teacher: "Dr. Miller", room: "Room-204" },
    ],
    Thursday: [
      { time: "09:00-10:30", subject: "Data Structures", teacher: "Dr. Smith", room: "Lab-1" },
      { time: "10:45-12:15", subject: "Mobile Development", teacher: "Ms. Garcia", room: "Lab-4" },
    ],
    Friday: [
      { time: "09:00-10:30", subject: "AI Ethics", teacher: "Prof. Chen", room: "Room-101" },
      { time: "10:45-12:15", subject: "Project Work", teacher: "Dr. Kumar", room: "Lab-2" },
    ],
  };
  ...
  useEffect(() => {
    ...
    setRecentActivity([
      { date: "2024-01-15", subject: "Data Structures", status: "present", time: "09:05" },
      { date: "2024-01-14", subject: "Mathematics", status: "present", time: "09:02" },
      { date: "2024-01-13", subject: "Database Systems", status: "late", time: "09:08" },
      { date: "2024-01-12", subject: "Web Development", status: "present", time: "09:01" },
      { date: "2024-01-11", subject: "Computer Networks", status: "absent", time: "--" },
    ]);
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case "late": return "text-yellow-400 bg-yellow-500/10 border-yellow-500/30";
          ...
          <div className="bg-gradient-to-r from-green-500/20 to-blue-500/20 backdrop-blur-xl rounded-2xl border border-white/20 p-6 shadow-2xl">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Attendance window is open for {upcomingClass.subject}</p>
                </div>
              </div>
              <div className="text-right">
                <div className="text-sm text-gray-400">Next Class</div>
                <div className="text-white font-semibold">{upcomingClass.time}</div>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-black/20 rounded-xl p-4 border border-white/10">
                ...
                <div className="text-white font-semibold">{upcomingClass.room}</div>
              </div>
              <div className="bg-black/20 rounded-xl p-4 border border-white/10">
                <div className="flex items-center space-x-2 mb-2">
                ...
                <div className="text-white font-semibold">GPS + Face + Code</div>
              </div>
            </div>
            ...
            <div className="bg-black/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-xl p-4 border border-blue-500/30">
                  <div className="text-2xl font-bold text-blue-400">{attendanceStats.percentage}%</div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-accent font-semibold">{attendanceStats.percentage}%</span>
                </div>
                ...
                <div className="text-xs text-gray-400">Target: 75% minimum required</div>
              </div>
            </div>
            ...
            <div className="bg-black/40 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
              ...
              <div className="space-y-3">
                {recentActivity.map((activity, index) => (
                  <div key={index} className="flex items-center justify-between bg-gray-800/50 rounded-xl p-4 border border-gray-700/50">
                    <div className="flex items-center space-x-4">
                      <div className={`w-3 h-3 rounded-full ${activity.status === "present" ? "bg-green-400" : activity.status === "absent" ? "bg-red-400" : "bg-yellow-400"}`} />
                      <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-300 text-sm">Face Registered</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-4 h-4 text-green-400" />
                    <span className="text-gray-300 text-sm">Device Verified</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="w-4 h-4 text-green-400" />
                    <span className="text-gray-300 text-sm">Location Access</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-300 text-sm">Mobile Verified</span>
                  </div>
                  <span className="text-blue-400 text-sm">+91 ***-***-1234</span>
                </div>
              </div>
            </div>
          </div>
